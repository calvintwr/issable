 ...
 */
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Issable = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
"use strict";
...
var is = function is(candidate, name) {
  ...
  var methods = {
    ...
    _statusCode: 400,
    _msg: '',
    _checker: function _checker(typing) {
      try {
    ...
    _errorModifier: function _errorModifier(error) {
      error.statusCode = this._statusCode;

      if (this._msg && this._msg.length > 0) {
        var message = '';
        if (this._name) message += "(Param: ".concat(this._name, ")");
...
var not = function not(candidate, name) {
...
},{"./core/NotTypeError":3,"./core/msgPOJO":4,"./core/primitives":5,"./helpers/customNameReplace":8,"./helpers/list":9,"./helpers/optionalReplace":10,"./helpers/suffixCheck":11,"./helpers/typeOf":12,"./lib/print":14}],3:[function(require,module,exports){
"use strict";
...
},{"./customNameReplace":8}],10:[function(require,module,exports){
"use strict";
...
},{"./You":2,"./customs/integer.js":6,"./customs/optional.js":7}],14:[function(require,module,exports){
"use strict";
